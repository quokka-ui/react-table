...
export const Primary: Story = {
    args: {
        mainColumns: ['Original Text', 'GPT Summary', 'Claude Summary', 'Llama Summary', 'XXX'],
        subColumns: ['Coherence', 'Clarity', 'Relevance', 'Correctness', 'Average'],
        data: [
            {
                descriptionColumn: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
                ...
                xxx: { coherence: 3, clarity: 4, relevance: 4, correctness: 4, average: 3.75 },
            },
            {
                descriptionColumn: 'Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
            ...
            {
                descriptionColumn: 'Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.',
